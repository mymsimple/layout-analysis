...
__C.COMMON.COCO_CLASS_NAMES_PATH = os.path.join(__C.COMMON.RELATIVE_PATH, "mask_rcnn/infos/coco_class_names.txt")
__C.COMMON.OUR_CLASS_NAMES_PATH = os.path.join(__C.COMMON.RELATIVE_PATH, "mask_rcnn/infos/our_class_names.txt")
...
__C.TEST.OUTPUT_IMAGE_PATH = os.path.join(__C.COMMON.RELATIVE_PATH, "./data/idcard/output/")
__C.TEST.CUT_IMAGE_PATH = os.path.join(__C.COMMON.RELATIVE_PATH, "./data/idcard/cut/")
__C.TEST.MASK_IMAGE_PATH = os.path.join(__C.COMMON.RELATIVE_PATH, "./data/idcard/mask/")
__C.TEST.FRAME_IMAGE_PATH = os.path.join(__C.COMMON.RELATIVE_PATH, "./data/idcard/frame/")
__C.TEST.APPROX_IMAGE_PATH = os.path.join(__C.COMMON.RELATIVE_PATH, "./data/idcard/approx/")
__C.TEST.CORRECT_IMAGE_PATH = os.path.join(__C.COMMON.RELATIVE_PATH, "./data/idcard/correct/")
